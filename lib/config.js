...
.option('--userDefinedHead <userDefinedHead>', 'Number of user defined headers (text, integers)', listValues)
.option('--range <range>',
...
const configInit = {
    ...
    simul: {
        ...
        userDefinedHead: [1, 1], //Number of user defined headers (text, integers)
