 ...
 * stored in the form accessKeyId:secretAccessKey
 * Retrieve passphrase for privateKey
 *      passphrase:string-for-passphrase
 * Retrieve password for publicKey
...
const config = {
    ...
    simul: {
        ...
        //  - 's3':   max %cpu usage of every IronMan-S3 process
        //  - 'ironman':  sum %cpu usage of all IronMan processes
        ssmTypes: 'all',
