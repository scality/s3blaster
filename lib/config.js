...
.option('--md-path [mdPath]', 'Path template of metadata store location. If relevant, <server_address> will be used for address of server') //eslint-disable-line
...
const config = {
    ...
    db: {
        ...
        objectsNb: 100,
        fillObjs: 'yes',  // flag for fillin objects in each bucket
        // fillRange: '0:100', // indices range for filling objects min:max
        fillThreads: 64,
